...
const LoyaltyCard = ({ stampsCount = 0 }) => {
  ...
  const renderStamps = () => {
      ...
      stamps.push(
        <div
          ...
          className={`w-9 h-9 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center font-extrabold text-sm transition-all duration-500 shadow-md ${
            isStamped
              ? 'bg-gradient-to-br from-amber-400 to-yellow-500 text-zinc-950 scale-105 border border-yellow-300 ring-2 ring-yellow-400/20'
              : 'bg-zinc-800/80 border border-zinc-700/50 text-zinc-400'
          }`}
        >
          {isStamped ? (
            <FaCheck size={14} className="animate-bounce-in" />
          ) : (
            i + 1
          )}
        </div>
    ...
    stamps.push(
      ...
      >
        <FaGift size={14} className={is10thFree ? 'animate-bounce text-emerald-100' : 'opacity-60'} />
        ...
        <div className="loyalty-card-inner">
          ...
          <div className="loyalty-card-front select-none relative">
            ...
            <div className="flex flex-col justify-center pl-6 text-left h-full">
              ...
              <div className="mt-2 bg-red-600 text-white font-extrabold text-2xl px-3.5 py-1 rounded-xl inline-block max-w-max shadow-lg shadow-red-500/20 tracking-wide uppercase border border-red-500">
                CARD
              </div>
            </div>
            ...
            <div className="h-full relative overflow-hidden flex items-center justify-center rounded-r-[1.4rem]">
              <div className="absolute inset-0 bg-gradient-to-r from-zinc-950 via-zinc-950/20 to-transparent z-10"></div>
              <img 
          ...
          <div className="loyalty-card-back select-none">
            ...
            <div className="text-center">
              ...
              <div className="w-12 h-0.5 bg-red-500 mx-auto mt-1 rounded-full"></div>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="bg-red-650 border border-red-500/20 rounded-full px-4 py-1 flex items-center gap-1.5 shadow-md shadow-red-500/15">
                <FaPhone size={9} className="text-white shrink-0" />
