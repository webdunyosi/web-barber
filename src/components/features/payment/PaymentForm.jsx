...
const PaymentForm = ({ paymentData, onUpdate, bookingInfo }) => {
  ...
  const setPaymentMethod = (method) => {
    onUpdate({ 
      ...
      receipt: method === 'cash' ? null : paymentData.receipt 
    })
    setErrors({})
  }
  ...
  return (
    <div className="w-full mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        {/* Order Summary */}
        <div className="bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 border border-zinc-700/30 rounded-2xl p-5 sm:p-6 text-white shadow-xl backdrop-blur-sm">
          ...
          <div className="space-y-2.5 text-sm">
            <div className="flex justify-between items-center">
              <span className="text-zinc-400 font-medium">Xizmat turi:</span>
              <span className="font-semibold text-zinc-200">{bookingInfo.service.name}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-400 font-medium">Belgilangan sana:</span>
              <span className="font-semibold text-zinc-200">{bookingInfo.date}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-400 font-medium">Belgilangan vaqt:</span>
              <span className="font-semibold text-zinc-200">{bookingInfo.time}</span>
            </div>
            <div className="border-t border-zinc-700/30 my-2"></div>
            <div className="flex justify-between items-center">
        ...
        {selectedMethod === 'card' ? (
          <div className="bg-gradient-to-br from-zinc-900 via-zinc-850 to-zinc-950 border border-zinc-700/30 rounded-2xl p-5 text-white shadow-xl relative overflow-hidden flex flex-col justify-between min-h-[180px]">
            ...
            <div className="relative z-10 flex flex-col justify-between h-full w-full">
              ...
              <div className="mb-4">
                <p className="text-[9px] text-zinc-400 uppercase tracking-widest mb-1.5 font-medium">Karta raqami</p>
              ...
              <div className="flex items-end justify-between gap-4 mt-auto">
                <div className="min-w-0">
                  <p className="text-[9px] text-zinc-400 uppercase tracking-widest mb-0.5 font-medium">Karta egasi</p>
          ...
          <div className="bg-gradient-to-br from-zinc-900 via-zinc-850 to-zinc-950 border border-zinc-700/30 rounded-2xl p-5 text-white shadow-xl relative overflow-hidden flex flex-col justify-between min-h-[180px]">
            ...
            <div className="relative z-10 flex flex-col justify-between h-full w-full">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-sm relative overflow-hidden shadow-inner shrink-0 flex items-center justify-center">
                    <span className="text-[10px] font-bold text-white">💵</span>
                  </div>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-400">
                    Sartaroshxonada To'lov
                  </span>
                </div>
                <div className="text-right shrink-0">
                  <span className="text-[10px] font-bold text-emerald-450 tracking-wider">JOYIDA</span>
                </div>
              </div>

              <div className="mb-4">
                <h4 className="text-sm sm:text-base font-bold text-zinc-150">To'lov sartaroshxonada qabul qilinadi</h4>
                <p className="text-xs text-zinc-400 leading-relaxed mt-1">
                  Mavjud bo'lgan barcha naqd pul, milliy valyuta hamda UZCARD/HUMO karta o'tkazmalari orqali sartaroshga bevosita hisob-kitob qilishingiz mumkin.
                </p>
              </div>

              <div className="mt-auto pt-2 border-t border-zinc-800/80 flex items-center gap-2 text-[10px] font-semibold text-zinc-400">
                <span>⚡️</span> Hech qanday oldindan to'lov va chek talab qilinmaydi.
              </div>
            </div>
          </div>
        )}
